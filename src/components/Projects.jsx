...
export const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Design & Funcionality",
      imgUrl: projImg3,
      url: "https://elaborar-bublanina-d1df2e.netlify.app"
    },
    {
      title: "Business Startup",
      description: "Design & Funcionality",
          ...
          <Col size={12}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn": ""}>
                <h2>Projects</h2>
                <p>Here I present my projects which I carried out during my frontend school stage with the Agile innova academy and they helped me to assimilate and understand how beautiful and interesting programming is, which gives you the opportunity to create what you dream of, programming will have put in place and shows you a better way to see the possibilities that there are in the world and in working life..</p>
                <Tab.Container id="projects-tabs" defaultActiveKey="first">
                  ...
                  <Tab.Content id="slideInUp" className={isVisible ? "animate__animated animate__slideInUp" : ""}>
                    ...
                    <Tab.Pane eventKey="third">
                      <p>I am a trustworthy person, very committed and when I promise something I always try to fulfill it, commitments are extremely important, I love playing sports and I am a soccer fan.</p>
                    </Tab.Pane>
                  </Tab.Content>
                </Tab.Container>
              </div>}
